 ...
 * - Mesmos enums e valores
 * - Mesmas computed properties
 * - Mesmos relacionamentos (serão implementados na Fase 2)
 * 
 * Features:
...
export class User extends BaseEntity {
  ...
  // Relacionamentos (Fase 2 - quando migrar roles)
  ...
  // Computed properties - FIDELIDADE TOTAL
