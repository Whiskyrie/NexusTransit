...
ALTER DEFAULT PRIVILEGES IN SCHEMA customers GRANT ALL PRIVILEGES ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES IN SCHEMA operations GRANT ALL PRIVILEGES ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES IN SCHEMA monitoring GRANT ALL PRIVILEGES ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES IN SCHEMA compliance GRANT ALL PRIVILEGES ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES IN SCHEMA incidents GRANT ALL PRIVILEGES ON TABLES TO postgres;
ALTER DEFAULT PRIVILEGES IN SCHEMA reports GRANT ALL PRIVILEGES ON TABLES TO postgres;
...
BEGIN
    ...
    WHERE schema_name IN ('auth', 'customers', 'operations', 'monitoring', 'compliance', 'incidents', 'reports');
    ...
    RAISE NOTICE '============================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Schemas criados: % de 7', schema_count;
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Execute as migrations de cada serviço com:';
    RAISE NOTICE '  pnpm --filter @nexus/auth-service migration:run';
    RAISE NOTICE '';
END $$;
